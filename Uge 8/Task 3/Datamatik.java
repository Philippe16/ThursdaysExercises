...
class Datamatik
{
	...
	{
		Teacher teacher1;
		teacher1 = new Teacher("Jesper", 200, false);

		Student student1;
		Student student2;

		student1 = new Student("Philippe", 25, false,"Group E");
		student2 = new Student("Oliver", 22, false,"Group E");

		System.out.println("The name of my teacher is "+teacher1.name+"");
		System.out.println("I am "+student1.name+", and this is "+student2.name+"");
		System.out.println("We are in "+student1.datamatikerTeam+"");
